    ...
    <div className="center third">
      <div className="card five">
        <div className="additional">
          ...
          <div className="more-info">
            ...
            <div className="info-buttons">
              <a
                href="https://everythingpip.netlify.app/"
                target="_blank"
                rel="noreferrer"
              >
                {" "}
              ...
              <a
                href="https://github.com/valentinbiz/everything-pip"
                target="_blank"
                rel="noreferrer"
              >
                {" "}
        ...
        <div className="general">
          ...
          <p>
            {" "}
            Application created with the purpose to help people make use of
            their screens in a more efficient way while studying/watching
